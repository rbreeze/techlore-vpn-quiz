...
class Finder extends React.Component {
    ...
    async componentDidMount() {
        let vpnData = (await (await fetch("http://localhost:5000/vpns")).json()).vpns.sort(vpnCompare); 
        let questionData = (await (await fetch("http://localhost:5000/questions")).json()).questions; 
...
const domContainer = document.querySelector('#finder-container');
ReactDOM.render(<Finder/>, domContainer);